...
GRASSROOTS_FRICTIONLESS_DATA_API json_t *GetCSVDialect (const char *delimter_s, const char *line_terminator_s,  const char *comment_char_p, const char *escape_char_p,
